      ...
      <div class="p-6 space-y-4">
        <div class="space-y-4">
          <div class="flex items-center space-x-3">
            <a-button type="primary" @click="openFile" title="选择 Bilibili 表情 JSON 文件进行导入">
              选择 Bilibili JSON 文件
            </a-button>
          ...
          <div class="flex items-center space-x-3">
            ...
            />
            <a-button @click="() => loadIndexFromUrl()" title="从 URL 加载 Bilibili 表情索引">
              加载索引
            </a-button>
          </div>
          ...
          <div class="flex items-center space-x-3">
            <AInput
              ...
              class="dark:bg-black dark:text-white"
            />
            <a-button type="primary" @click="applySearch" title="搜索 Bilibili 表情包">
              搜索
            </a-button>
            <a-button type="default" @click="query = ''" title="清空搜索关键词">清空</a-button>
            <a-button
              type="primary"
              @click="importSelectedFromIndex"
              title="导入选中的 Bilibili 表情包"
            >
              导入选中包
            </a-button>
          </div>
          ...
          <div class="mt-4 p-3 border rounded bg-gray-50 dark:bg-gray-700">
            ...
            <div class="mt-3 flex items-center space-x-3">
              <a-button
                type="primary"
                @click="fetchSingleId"
                title="单次获取指定 ID 的 Bilibili 表情包"
              >
                单次获取
              </a-button>
              <a-button
                type="primary"
                @click="fetchByIdLoop"
                :disabled="isFetchingById"
                title="开始连续拉取 Bilibili 表情包"
              >
                开始连续拉取
              </a-button>
              <a-button
                type="default"
                @click="stopFetchingById"
                :disabled="!isFetchingById"
                title="停止连续拉取"
              >
                停止
