...
<template>
  <div v-if="activeTab === 'image-editor'" class="space-y-6">
    <div class="bg-gradient-to-br from-green-600 to-blue-700 text-white p-6 rounded-lg">
      ...
      <p class="text-green-100">基于画布的全面图像编辑工具，包含工具、调整和滤镜功能</p>
    </div>
        ...
        <div class="flex">
          ...
          <div class="w-64 ml-6 space-y-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <a-slider
                    v-model:value="adjustments.brightness"
                    :min="-100"
                    :max="100"
                ...
                <div>
                  ...
                  <a-slider
                    v-model:value="adjustments.contrast"
                    :min="-100"
                    :max="100"
                    @change="applyAdjustments"
                  />
                ...
                <div>
                  ...
                  <a-slider
                    v-model:value="adjustments.saturation"
                    :min="-100"
                    :max="100"
                    @change="applyAdjustments"
                  />
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
              ...
              <div class="text-xs text-gray-500 mt-2">{{ history.length }} 个步骤</div>
            </div>
          </div>
        </div>
      </div>
