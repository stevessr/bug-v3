  ...
  <div class="space-y-8">
    <div class="bg-white shadow rounded-lg">
      ...
      <div class="p-6 space-y-6">
        ...
        <!-- Import Results -->
        <div v-if="importResults" class="border rounded-lg p-4" :class="importResults.success ? 'bg-green-50' : 'bg-red-50'">
          <div class="flex items-start">
            <svg v-if="importResults.success" class="w-5 h-5 text-green-500 mr-3 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
            </svg>
            <svg v-else class="w-5 h-5 text-red-500 mr-3 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" />
            </svg>
            <div class="flex-1">
              <p :class="importResults.success ? 'text-green-700' : 'text-red-700'" class="text-sm font-medium">
                {{ importResults.message }}
              </p>
              <p v-if="importResults.details" :class="importResults.success ? 'text-green-600' : 'text-red-600'" class="text-sm mt-1">
