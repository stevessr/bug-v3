...
declare global {
  ...
  const applyExtensionSurfaceClass: typeof import('./utils/appMode').applyExtensionSurfaceClass
  ...
  const clearTenorCache: typeof import('./utils/tenor').clearTenorCache
  const cloudflareSyncService: typeof import('./utils/cloudflareSync').cloudflareSyncService
  ...
  const debounceAsync: typeof import('./utils/tenor').debounceAsync
  ...
  const fetchTenorMediaAsBlob: typeof import('./utils/tenor').fetchTenorMediaAsBlob
  ...
  const tenorFeatured: typeof import('./utils/tenor').tenorFeatured
  const tenorSearch: typeof import('./utils/tenor').tenorSearch
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { UseEmojiImagesOptions } from './composables/useEmojiImages'
  import('./composables/useEmojiImages')
  // @ts-ignore
  export type { ExtensionSurface, ExtensionSurfaceResolution } from './utils/appMode'
  import('./utils/appMode')
  // @ts-ignore
  export type { CloudflareSyncService, ExtendedCloudflareConfig, ExtendedSyncData, SyncProgress } from './utils/cloudflareSync'
  import('./utils/cloudflareSync')
  // @ts-ignore
  export type { CollaborativeUploadConfig, ConnectionStatus, UploadProgress, WorkerStats, ServerStats, UploadTask, UploadTaskWithData, UploadResult, MessageHandler } from './utils/collab/types'
  import('./utils/collab/types')
  // @ts-ignore
  ...
  import('./utils/emojiMarkdown')
  // @ts-ignore
  export type { EmojiUrlRewriteField, EmojiUrlRewriteResult } from './utils/emojiUrlRewrite'
  import('./utils/emojiUrlRewrite')
  // @ts-ignore
  export type { GeminiConfig, ImageAnalysisResult, StreamingCallback } from './utils/geminiService'
  import('./utils/geminiService')
  // @ts-ignore
  export type { ImageCache, ImageCacheOptions, CacheEntry } from './utils/imageCache'
  import('./utils/imageCache')
  // @ts-ignore
  export type { ImageCacheStrategy } from './utils/imageCachePolicy'
  import('./utils/imageCachePolicy')
  // @ts-ignore
  export type { ImageCacheService, CachedImage, CacheStats } from './utils/imageCacheService'
  import('./utils/imageCacheService')
  // @ts-ignore
  export type { ImageUrlOptions } from './utils/imageUrlHelper'
  import('./utils/imageUrlHelper')
  // @ts-ignore
  export type { LogLevel, ContextLogger } from './utils/logger'
  import('./utils/logger')
  // @ts-ignore
  export type { StorageChangeListener } from './utils/simpleStorage'
  import('./utils/simpleStorage')
  // @ts-ignore
  export type { SyncDatabase } from './utils/sync-db'
  import('./utils/sync-db')
  // @ts-ignore
  export type { WebDAVSyncTarget, S3SyncTarget, CloudflareSyncTarget, SyncConfig, WebDAVConfig, S3Config, CloudflareConfig, SyncTargetConfig, SyncResult, SyncData, GroupLike, Progress, ProgressCallback, ISyncTarget } from './utils/syncTargets'
  import('./utils/syncTargets')
  // @ts-ignore
  export type { TelegramFileInfo, TelegramSticker, TelegramStickerSet } from './utils/telegramResolver'
  import('./utils/telegramResolver')
  // @ts-ignore
  ...
  import('./utils/webmToAvifBackend')
}
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly applyExtensionSurfaceClass: UnwrapRef<typeof import('./utils/appMode')['applyExtensionSurfaceClass']>
    ...
    readonly clearTenorCache: UnwrapRef<typeof import('./utils/tenor')['clearTenorCache']>
    readonly cloudflareSyncService: UnwrapRef<typeof import('./utils/cloudflareSync')['cloudflareSyncService']>
    ...
    readonly debounceAsync: UnwrapRef<typeof import('./utils/tenor')['debounceAsync']>
    ...
    readonly fetchTenorMediaAsBlob: UnwrapRef<typeof import('./utils/tenor')['fetchTenorMediaAsBlob']>
    ...
    readonly tenorFeatured: UnwrapRef<typeof import('./utils/tenor')['tenorFeatured']>
    readonly tenorSearch: UnwrapRef<typeof import('./utils/tenor')['tenorSearch']>
