...
function processImageCarousel(carousel: Element) {
  try {
    ...
    const images = carousel.querySelectorAll('img[src*="pbs.twimg.com"], img[src*="twimg.com"]') as NodeListOf<HTMLImageElement>;
  ...
  try {
    ...
    carouselSelectors.forEach(selector => {
      ...
      elements.forEach(element => {
        ...
        const carousel = element.closest('[data-testid="tweetPhoto"]') || 
