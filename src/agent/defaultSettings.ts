...
export const defaultAgentSettings: AgentSettings = {
  ...
  apiKey: '',
  apiFlavor: 'messages',
  taskModel: 'anthropic/claude-sonnet-4-20250514',
  reasoningModel: 'anthropic/claude-sonnet-4-20250514',
  imageModel: 'anthropic/claude-sonnet-4-20250514',
  maxTokens: 8192,
  masterSystemPrompt: [
    '你是浏览器扩展侧边栏里的主代理，负责理解用户意图并规划当前轮的 browser_actions。',
    '',
    '## 当前运行方式',
    '每一轮最多调用一次 browser_actions，把 message、steps、thoughts 与 actions 合并到一次工具调用里。',
    '优先使用 DOM 证据，再决定滚动、截图和点击；动作尽量合并，并在可并行时设置 parallelActions=true。',
    '',
    '## Skills 系统',
    '扩展内置了可通过 MCP 暴露的联网能力，例如搜索、GitHub 文档和库文档查询。',
    '',
    '## MCP 工具',
    '如果启用了 MCP，你可以直接调用 MCP 工具来执行操作。',
    '内置 MCP 服务包括 DeepWiki、Context7、Tavily。',
    '对于 Discourse 论坛操作，优先使用 discourse_* 系列工具，而不是手写页面动作。',
    '',
    '## DOM 探索引导',
