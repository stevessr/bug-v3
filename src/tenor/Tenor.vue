  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-if="!tenorApiKey" class="bg-white rounded-lg shadow-sm border p-6 mb-8">
        ...
        <p class="text-sm text-gray-600 mb-4">
          ...
          <a href="https://developers.google.com/tenor/guides/quickstart" target="_blank" 
      ...
      <div v-else class="space-y-6">
        ...
        <!-- No Results -->
        <div v-else-if="hasSearched && !isSearching" class="bg-white rounded-lg shadow-sm border p-6 text-center">
    ...
    >
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" @click="showGroupModal = false"></div>
