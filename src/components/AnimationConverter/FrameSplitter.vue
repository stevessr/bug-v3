...
<template>
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    ...
    <p class="text-gray-600 mb-6">将动图拆分为单独的图片帧</p>
    ...
    >
      ...
      <div v-if="!selectedFile">
        ...
        <p class="text-xs text-gray-500 mt-1">支持 GIF, APNG 格式</p>
      </div>
    ...
    <div v-if="selectedFile" class="mt-6 space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">帧范围</label>
          <select
            v-model="frameRange"
            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          >
        ...
        <div v-if="frameRange === 'interval'">
          <label class="block text-sm font-medium text-gray-700 mb-2">间隔 (每N帧取1帧)</label>
          <input
      ...
      <div v-if="frameRange === 'range'" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">起始帧</label>
          <input
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">结束帧</label>
          <input
