  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="flex h-screen">
      ...
      <div class="flex-1 flex flex-col">
        ...
        <!-- Status Bar -->
        <div v-if="imageLoaded" class="bg-white border-t border-gray-200 px-4 py-2 flex justify-between items-center text-sm text-gray-600">
          <div>
    ...
    <!-- Text Input Modal -->
    <div v-if="showTextModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    ...
    img.onload = () => {
      ...
      nextTick(() => {
        ...
        if (ctx.value) {
          ...
          // 保存原始图像数据
          originalImageData.value = ctx.value.getImageData(0, 0, canvasWidth.value, canvasHeight.value);
...
const applyAdjustments = () => {
  ...
  for (let i = 0; i < data.length; i += 4) {
    ...
    // 对比度调整
    const contrastFactor = (259 * (adjustments.value.contrast + 255)) / (255 * (259 - adjustments.value.contrast));
